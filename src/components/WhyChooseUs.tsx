...
export const WhyChooseUs: React.FC = () => {
  ...
  return (
    <section id="pourquoi" className="py-20 bg-[#F5F2F5] border-t border-[#D8D2D8]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 text-left space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-[#EFE8EE] border border-[#6B3F63]/20 space-y-2 shadow-sm">
              <div className="flex items-center gap-2 text-[#6B3F63]">
                <HeartHandshake className="w-5 h-5" />
                <h3 className="font-serif font-bold text-base">Notre promesse</h3>
              </div>
              <p className="font-serif italic text-sm text-[#2A2430]/90 leading-relaxed">
            ...
            {features.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-white border border-[#D8D2D8]/80 shadow-xs hover:shadow-md transition-shadow flex items-start gap-5 text-left group"
                >
                  <div className="p-3.5 rounded-xl bg-[#6B3F63]/10 text-[#6B3F63] group-hover:bg-[#6B3F63] group-hover:text-white transition-colors duration-300 shrink-0">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="font-serif text-sm text-[#2A2430]/70 leading-relaxed">
                      {item.description}
                    </p>
                  </div>
                </motion.div>
